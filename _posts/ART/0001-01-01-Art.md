...
| . | |  |
| - | - |- |
|**DNA** | `Culture`, `Time`, `Period` ('80), `Function` |Universal, Cultural / Animalistic, Manufactured    
...
Design thinking not generic! intermix is generic garbage nothing with design.

The applied arts. satisfy goals and constraints taking into account aesthetic, functional, economic, or socio-political considerations



understand character of design and intention was when creating those products.

 (Maked for speed? like motocycles  ) when was made '80 '90. Different character. Curved or quad, weight, level of detail

Choose key words to understand key representative things


if u need design something in similar style reverse engenire  Find key words and find references they maight use . understand design influences
...
- **Focal point**, composition lines (but its not true that they lead eye (physically) its not literally its only specializing abstract concept ). If character in scene, focal point is wher is head or wher he look.
- **Depth**
- **Edges**
...
start with basics: dark mid light/ fore mid back-ground   
...
# Sculpt
Sculpting is about volume, form and silhouete.  
