...
- People have Trichromatic Vision - Cone cells are sensitive in bandth in wavelength of RGB
...
- **The Opponent-Process Theory** - Complementarty to trichromatic. working in pares and complement eachother. (**RGBY**) Inability to color combine. Oposites:  
...
######  Compose Patterns
- `Cyan` appear most light then: `Green` > `Yellow` > `red` > `blue` appear as darkest.
