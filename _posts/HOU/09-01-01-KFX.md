...
Kurs Vimeo + PDF
[YT SideFX - Fur dude](https://media.sidefx.com/files/tutorials/kinefx-rigging-fur-dude)
[YT SideFX PDF ](/kinefx_rigging_fur_dude2.pdf)
...
- Start from root > child. (from site view viewport). Hierarchy is determined by vertex order. However, point ordering is not considered when traversing the hierarchy.
...
- Orient of joints:  in unreal green Y is -Y in Houdini  
