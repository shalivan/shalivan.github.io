...
## Secondary motion
1. [ **rig statch pose** ] SOP with `rest_transform` (used by secondary motion)
2.  Motion clip / [ **secondary motion** ] SOP  to convert to clips
...
##### Solve Curve
- solve curve to normalize bone lengths
