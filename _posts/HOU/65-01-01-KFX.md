...
https://www.youtube.com/watch?v=hpigyuZv784&t=470s
...
need 2 joints   
- `efective localxform`  - scale inheritance attribute `i@scaleinheritance = chi("scale_inheritancei");`
...
- `Lookat Constraint` or `Lookat (kinefx)` - drag 3 vectors from viewport   
