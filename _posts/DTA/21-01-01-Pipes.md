...
---
> Pxlink: [[DTA]]
>Obsidian: [[DTA]] [[12-01-01-USD]] [[20-01-01-Res]]  [[13-01-01-Houdini]]
...
- `$HIP/`
	- `$HIPNAME.hip`  
	- `/obj/`
		- ``` /`opname("..")`/ ```  (moze byc duzo assetów albo asset per geo_node) / GEO OBJ SOP
			- `/out/`
...
| ![B](/src/pipe/axies_blend.png) | 3ds Max, Blender, CryEngine, Auto Cad, Source, SketchUp      | **R, Z-Up**<br>Z>Y>X  | X,-Z,Y                    | X,-Z,Y,W                      |
