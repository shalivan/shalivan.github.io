...
- `0.18` linear ≈ sRGB **118** (18% gray / “photographic middle gray”)
- `0.214` linear ≈ sRGB **128** (“UI middle” / 50% sRGB gray)
- `0.5` linear ≈ sRGB **188**
...
In linear the **bright values are as important as the dark** ones.
...
| Game                  | Year | Size (km²) | Type of World        | Density     | Notes                              | Travel Time     |
| --------------------- | ---- | ---------- | -------------------- | ----------- | ---------------------------------- | --------------- |
| Apex Legends          | 2019 | ~3.6       | Battle royale arena  | High        | Small but dense POI clusters       |                 |
| Fortnite (Chapter 1)  | 2017 | ~6–7       | Battle royale island | Medium      | Balanced traversal & POI clusters  | 3–4 min         |
| GTA III               | 2001 | ~8         | Urban city           | Very high   | Compact early open world           |                 |
| L.A. Noire            | 2011 | ~21        | Urban city           | Medium      | Large city but limited interaction |                 |
| Skyrim                | 2011 | ~37        | Fantasy landscape    | Medium      | Many Dungeons + vertical terrain   |                 |
| GTA San Andreas       | 2004 | ~38        | Cities + countryside | Medium      | 3 cities + large rural areas       |                 |
| PUBG (Erangel)        | 2017 | 64         | Battle royale island | Low         | Large spaces POI clusters          | 8–10 min        |
| GTA V                 | 2013 | ~80        | City + countryside   | Medium-high | One dense city + rural areas       | ~8 min (car)    |
| Red Dead Redemption 2 | 2018 | ~75–127*   | Natural landscape    | Medium      | Large biomes and sparse towns      | ~20 min (horse) |
