...
Keep key when powering on (bool switch)

`C2` - Auto Power Off    
   - The [TYPE] knob’s Clv lamp and the lamps from the TREMOLO/WAH to D.DELAY/A.DELAY sections flash      

`C#2` -

`D2` -  Speaker Output
  - ON: The [TYPE] knob’s Clv lamp and the lamps from the TREMOLO/WAH to D.DELAY/A.DELAY sections light up.
  - off: The [TYPE] knob’s Clv lamp and the lamps from the TREMOLO/WAH to D.DELAY/A.DELAY sections flash.
...
`A3` - master tuning (1.30)  ?????
  - 440.0 Hz The [TYPE] knob’s Clv lamp and the lamps from the TREMOLO/WAH to D.DELAY/A.DELAY sections light up.
  - 442.0 Hz The [TYPE] knob’s Clv lamp and the lamps from the TREMOLO/WAH to D.DELAY/A.DELAY sections flash.

`C5` - Factory Default  - The TYPE lamps flash      


`A3` (13-th white), `C#4` (11 black), `E4` (17 white) + `ON` - to Advanced mode  !!!!!!!!!  In this mode, all of the [TYPE] lamps light up, and you can change parameters by using the keyboard
...
- Release the C2 key and confirm that all of the [TYPE] lamps light up. you can try sound on the right side of keybowr


Transpose: in semitone units (where 12 semitones equals one octave).
- `D2` +
  - `C3`... - 12 semi ...
  - `C4` - 0
  - `C5` - + 12 semi
