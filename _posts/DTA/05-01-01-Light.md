...
red light is low on energy.

Burning stuf > pump electircity throu filament >  Gaz (most not white), discharged (neon) and pump high voltage  (add flurecent to controll collor) >   Gas discharged lamps (high pressure gas) product arc. (high voltage) > LED's (hard to find blue leds).
...
Ultraviolet | 10  - 400 nm | much energy - not healthy
