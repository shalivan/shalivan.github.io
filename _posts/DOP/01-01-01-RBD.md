...
### States
Na spakowanegj geo przed solverem:
- `i@active=1;` - Do solve.     
- `i@deforming=1;` Animation is packed in to deforming object. (Will recompute collision every frame! )    
- `i@animated=1;`  Pack parts are animated.    
