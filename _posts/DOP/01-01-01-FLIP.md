...
##### Reseed
With Reseed Particles turned off You can get an uneven distribution due to numerical error.  

##### Separation
Additional separation that prevent volume compression verriten by velocity.

##### Droplets:  
Tend to clamp toghether when partic drop below certain density turn to droplets more likely.
