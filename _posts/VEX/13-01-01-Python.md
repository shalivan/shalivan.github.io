...
Like list - tupples are immutable. not changable - (less storage, quicker to accces, more efficient. )
...
## List
List - collection: order, mutible, allow duplicates.  can contain different dat types
```python
...
## Tuple
Like list - tupples are immutable.
```python
